...
final class RuntimeCrashPlaybook {
    ...
    private static final Clause[] CLAUSES = {
            ...
            new Clause(new String[]{"InflateException"},
                    "- Layout inflation failed: a view tag in the inflated XML has a wrong/missing class or a bad attribute; fix the offending tag.",
                    "- 布局 inflate 失败：被加载 XML 里某个 view 标签的类名错误/缺失或属性非法；修正该标签。"),
